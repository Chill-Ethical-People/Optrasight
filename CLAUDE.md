# CLAUDE.md — Handover brief for Claude Local CLI

> **Read this file first when you (Claude) are picking up the OptraSight codebase.** It is the fastest path from cold-start to productive work.
